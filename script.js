...
// Seleccionamos el enlace de "Inicia Sesión"
const linkLogin = document.getElementById('ir-a-login');

if (linkLogin) {
    linkLogin.addEventListener('click', (e) => {
        e.preventDefault(); // Evita que la página se recargue
        
        // Aquí le decimos que oculte la caja de registro y muestre la de login
        // O si tienes una página separada para login:
